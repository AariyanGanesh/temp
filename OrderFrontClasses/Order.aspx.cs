...
public partial class Order : System.Web.UI.Page
{
    ...
    Int32 DisplayOrder(string ItemTypeFilter)
    {
        ...
        string ItemName; //var to store the game name
        string ItemType; // var to store the publisher
        clsOrderCollection MyOrderCollection = new clsOrderCollection();//create an instance of the Order collection class
        ...
        while (Index < RecordCount)//while there are records to process
        {
            ...
            lstOrder.Items.Add(NewEntry);//add the games to the list
